        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-[10px] text-cyan-300 uppercase">Wallet</div>
            ...
            <div className="flex md:hidden items-center gap-2">
              ...
              <button
                onClick={() => setWalletModalOpen(true)}
                className="flex items-center gap-1.5 rounded-lg border border-cyan-500/20 bg-cyan-500/10 px-3 py-1.5 hover:bg-cyan-500/20 transition-all"
              >
                <Wallet className="h-4 w-4 text-cyan-400" />
                  ...
                  <div className="flex flex-col gap-6 pt-8">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium border border-cyan-500/20 bg-cyan-500/10 text-cyan-300 hover:bg-cyan-500/20 transition-all"
                      >
