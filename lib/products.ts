...
export const mobileProducts: Product[] = [
...

  {
    ...
    status: "ONLINE",
    prices: [
      { duration: "6 Hours", priceINR: "₹35", resellerPrice: "₹25", priceUSD: "$1.38", sellerDuration: "6 Hours" },
      { duration: "12 Hours", priceINR: "₹65", resellerPrice: "₹38", priceUSD: "$2.20", sellerDuration: "12 Hours" },
      { duration: "1 DaYs", priceINR: "₹95", resellerPrice: "₹65", priceUSD: "$3.75", sellerDuration: "1 DaYs" },
      { duration: "7 DaYs", priceINR: "₹395", resellerPrice: "₹215", priceUSD: "$6.90", sellerDuration: "7 DaYs" },
    ],
    updateChannel: "https://t.me/+JNLfa2pGuYxlNWNl",
