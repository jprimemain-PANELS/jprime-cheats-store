...
export const mobileProducts: Product[] = [
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", priceINR: "₹90", resellerPrice: "₹49", priceUSD: "$1.38" },
      { duration: "3 day", priceINR: "₹180", resellerPrice: "₹79",priceUSD: "$2.20" },
      { duration: "7 day", priceINR: "₹340", resellerPrice: "₹149",priceUSD: "$3.75" },
      { duration: "15 day", priceINR: "₹640", resellerPrice: "₹249",priceUSD: "$6.90" },
      { duration: "31 day", priceINR: "₹890", resellerPrice: "₹349",priceUSD: "$9.80" },
    ],
    updateChannel: "https://t.me/+JNLfa2pGuYxlNWNl",
    features: ["ʜᴇᴀᴅꜱʜᴏᴛ","ᴀɪᴍ ᴍᴀɢɴᴇᴛ","ꜱɪʟᴇɴᴛ ᴀɪᴍ","ᴀɪᴍʙᴏᴛ ʟᴇɢɪᴛ","ꜱᴘᴇᴇᴅ ᴛɪᴍᴇʀ","ɢʜᴏꜱᴛ ʜᴀᴄᴋ","ᴇꜱᴘ ʟɪɴᴇ ʟᴏᴄᴀᴛɪᴏɴ","🄲🅂 / 🄱🅁 ʀᴀɴᴋ ᴡᴏʀᴋɪɴɢ","ᴍᴀɪɴ ɪᴅ ꜱᴀꜰᴇ (ʀᴏᴏᴛ ᴍᴏʙɪʟᴇ)"],
  },
  {
