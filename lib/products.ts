...
export const pcProducts: Product[] = [
  {
    ...
    category: "pc",
    prices: [
      { duration: "1 day", priceINR: "₹99", resellerPrice: "₹48", priceUSD: "$1.40" },
      { duration: "10 day", priceINR: "₹485", resellerPrice: "₹245", priceUSD: "$5.30" },
      { duration: "31 day", priceINR: "₹885", resellerPrice: "₹490", priceUSD: "$8.95" },
    ],
    updateChannel: "https://t.me/+vNW83oEZIzw3Y2Fl",
