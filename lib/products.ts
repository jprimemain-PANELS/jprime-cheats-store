...
export const mobileProducts: Product[] = [
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", priceINR: "₹95", resellerPrice: "₹47", priceUSD: "$1.38" },
      { duration: "3 day", priceINR: "₹185", resellerPrice: "₹75",priceUSD: "$2.20" },
      { duration: "7 day", priceINR: "₹349", resellerPrice: "₹145",priceUSD: "$3.75" },
      { duration: "15 day", priceINR: "₹640", resellerPrice: "₹245",priceUSD: "$6.90" },
      { duration: "31 day", priceINR: "₹899", resellerPrice: "₹335",priceUSD: "$9.80" },
    ],
