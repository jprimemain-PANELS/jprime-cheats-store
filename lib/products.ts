...
export const mobileProducts: Product[] = [
  {
    ...
    prices: [
      ...
      { duration: "3 day", priceINR: "₹185", resellerPrice: "₹80",priceUSD: "$2.20" },
      { duration: "7 day", priceINR: "₹349", resellerPrice: "₹150",priceUSD: "$3.75" },
      { duration: "15 day", priceINR: "₹640", resellerPrice: "₹250",priceUSD: "$6.90" },
      { duration: "31 day", priceINR: "₹899", resellerPrice: "₹350",priceUSD: "$9.80" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", priceINR: "₹95", resellerPrice: "₹45", priceUSD: "$1.38" },
