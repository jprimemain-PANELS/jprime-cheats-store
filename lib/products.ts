...
export const mobileProducts: Product[] = [
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", priceINR: "₹75", resellerPrice: "₹28", priceUSD: "$1.38" },
      { duration: "3 day", priceINR: "₹150", resellerPrice: "₹66",priceUSD: "$2.20" },
      { duration: "7 day", priceINR: "₹320", resellerPrice: "₹119",priceUSD: "$3.75" },
      { duration: "15 day", priceINR: "₹580", resellerPrice: "₹180",priceUSD: "$6.90" },
      { duration: "31 day", priceINR: "₹695", resellerPrice: "₹280",priceUSD: "$9.80" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", priceINR: "₹75", resellerPrice: "₹45", priceUSD: "$1.38" },
      { duration: "3 day", priceINR: "₹135", resellerPrice: "₹65",priceUSD: "$2.20" },
      { duration: "7 day", priceINR: "₹275", resellerPrice: "₹139",priceUSD: "$3.75" },
      { duration: "31 day", priceINR: "₹545", resellerPrice: "₹235",priceUSD: "$9.80" },
    ],
    updateChannel: "https://t.me/+JNLfa2pGuYxlNWNl",
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", priceINR: "₹99", resellerPrice: "₹45", priceUSD: "$1.30" },
      { duration: "7 day", priceINR: "₹349", resellerPrice: "₹135",priceUSD: "$3.75" },
      { duration: "15 day", priceINR: "₹599", resellerPrice: "₹275",priceUSD: "$6.90" },
      { duration: "31 day", priceINR: "₹899", resellerPrice: "₹375",priceUSD: "$9.80" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", resellerPrice: "₹29", priceINR: "₹89" },
      { duration: "3 day", resellerPrice: "₹59", priceINR: "₹159" },
      { duration: "7 day", resellerPrice: "₹119",priceINR: "₹309" },
      { duration: "10 day", resellerPrice: "₹147",priceINR: "₹559" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", priceINR: "₹78", resellerPrice: "₹28", priceUSD: "$1.38" },
      { duration: "3 day", priceINR: "₹150", resellerPrice: "₹68",priceUSD: "$2.20" },
      { duration: "7 day", priceINR: "₹350", resellerPrice: "₹138",priceUSD: "$3.75" },
      { duration: "15 day", priceINR: "₹620", resellerPrice: "₹268",priceUSD: "$6.90" },
      { duration: "31 day", priceINR: "₹920", resellerPrice: "₹528",priceUSD: "$9.80" },
      ...
      { duration: "7 day brutal", priceINR: "₹350", resellerPrice: "₹138",priceUSD: "$3.75" },
      { duration: "15 day brutal", priceINR: "₹620", resellerPrice: "₹268",priceUSD: "$6.90" },
      { duration: "31 day brutal", priceINR: "₹920", resellerPrice: "₹528",priceUSD: "$9.80" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", resellerPrice: "₹45", priceINR: "₹95" },
      { duration: "10 day", resellerPrice: "₹149", priceINR: "₹349" },
      { duration: "31 day", resellerPrice: "₹299", priceINR: "₹650" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "10 day", resellerPrice: "₹1", priceINR: "₹580" },
...
export const pcProducts: Product[] = [
  ...
  },
  {
    ...
    category: "pc",
    prices: [
      { duration: "1 day", resellerPrice: "₹40", priceINR: "₹95" },
      { duration: "15 day", resellerPrice: "₹255", priceINR: "₹589" },
  ...
  },
  {
    ...
    category: "pc",
    prices: [
      { duration: "1 day", resellerPrice: "₹40", priceINR: "₹90" },
