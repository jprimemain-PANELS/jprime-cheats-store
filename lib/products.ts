...
export const mobileProducts: Product[] = [
  {
    ...
    prices: [
      ...
      { duration: "3 day", priceINR: "₹185", resellerPrice: "₹49",priceUSD: "$2.20" },
      { duration: "7 day", priceINR: "₹349", resellerPrice: "₹49",priceUSD: "$3.75" },
      { duration: "15 day", priceINR: "₹640", resellerPrice: "₹49",priceUSD: "$6.90" },
      { duration: "31 day", priceINR: "₹899", resellerPrice: "₹49",priceUSD: "$9.80" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", priceINR: "₹98", resellerPrice: "₹49",priceUSD: "$1.40" },
      { duration: "7 day", priceINR: "₹349", resellerPrice: "₹49",priceUSD: "$3.75" },
      { duration: "31 day", priceINR: "₹899", resellerPrice: "₹49",priceUSD: "$9.80" },
    ],
    updateChannel: "https://t.me/+JNLfa2pGuYxlNWNl",
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", priceINR: "₹99", resellerPrice: "₹49", priceUSD: "$1.30" },
      { duration: "7 day", priceINR: "₹349", resellerPrice: "₹49",priceUSD: "$3.75" },
      { duration: "15 day", priceINR: "₹599", resellerPrice: "₹49",priceUSD: "$6.90" },
      { duration: "31 day", priceINR: "₹899", resellerPrice: "₹49",priceUSD: "$9.80" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", resellerPrice: "₹49", priceINR: "₹89" },
      { duration: "3 day", resellerPrice: "₹49", priceINR: "₹159" },
      { duration: "7 day", resellerPrice: "₹49",priceINR: "₹359" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", resellerPrice: "₹49", priceINR: "₹130" },
      { duration: "10 day", resellerPrice: "₹49", priceINR: "₹390" },
      { duration: "31 day", resellerPrice: "₹49", priceINR: "₹690" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "10 day", resellerPrice: "₹49", priceINR: "₹580" },
      { duration: "20 day", resellerPrice: "₹49", priceINR: "₹1080" },
      { duration: "30 day", resellerPrice: "₹49", priceINR: "₹1580" },
    ],
...
export const pcProducts: Product[] = [
  {
    ...
    category: "pc",
    prices: [
      { duration: "1 day", priceINR: "₹129", resellerPrice: "₹49", priceUSD: "$1.40" },
      { duration: "10 day", priceINR: "₹495", resellerPrice: "₹49", priceUSD: "$5.30" },
      { duration: "31 day", priceINR: "₹839", resellerPrice: "₹49", priceUSD: "$8.95" },
    ],
    updateChannel: "https://t.me/+vNW83oEZIzw3Y2Fl",
  ...
  },
  {
    ...
    category: "pc",
    prices: [
      { duration: "1 day", resellerPrice: "₹49", priceINR: "₹180" },
      { duration: "11 day", resellerPrice: "₹49", priceINR: "₹559" },
      { duration: "31 day", resellerPrice: "₹49", priceINR: "₹1399" },
      { duration: "Lifetime", resellerPrice: "₹49", priceINR: "₹3299" },
    ],
