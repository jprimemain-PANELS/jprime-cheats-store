...
export const mobileProducts: Product[] = [
  {
    ...
    prices: [
      ...
      { duration: "3 day", priceINR: "₹185", resellerPrice: "₹72",priceUSD: "$2.20" },
      { duration: "7 day", priceINR: "₹349", resellerPrice: "₹142",priceUSD: "$3.75" },
      { duration: "15 day", priceINR: "₹640", resellerPrice: "₹242",priceUSD: "$6.90" },
      { duration: "31 day", priceINR: "₹899", resellerPrice: "₹339",priceUSD: "$9.80" },
    ],
  ...
  },
  {
    ...
    prices: [
      ...
      { duration: "7 day", priceINR: "₹349", resellerPrice: "₹145",priceUSD: "$3.75" },
      { duration: "15 day", priceINR: "₹599", resellerPrice: "₹295",priceUSD: "$6.90" },
      { duration: "31 day", priceINR: "₹899", resellerPrice: "₹399",priceUSD: "$9.80" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "1 day", resellerPrice: "₹42", priceINR: "₹130" },
      { duration: "10 day", resellerPrice: "₹138", priceINR: "₹390" },
      { duration: "31 day", resellerPrice: "₹299", priceINR: "₹690" },
    ],
  ...
  },
  {
    ...
    category: "mobile",
    prices: [
      { duration: "10 day", resellerPrice: "₹450", priceINR: "₹580" },
